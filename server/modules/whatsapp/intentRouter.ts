...
function routeNonFoodRequests(input: RouteInput, normalized: string): WhatsappPreNutritionRouterDecision | null {
  ...
  const patterns: Array<{
    ...
    { pattern: /\b(historico|historico alimentar|meus registros|registros alimentares|refeicoes registradas|o que registrei|o que eu comi)\b/, intent: "consulta_historico", outputType: "texto", reply: "Entendi que você quer consultar seus registros. Não vou criar alimento com essa mensagem.", reason: "history_request" },

...
const PERSONAL_CONTEXT_PATTERN = /\b(?:eu|meu|minha|meus|minhas|comi|consumi|bebi|fiz|estou|tenho|tive|peso|meta|metas|consumo|consumido|consumida|ingeri|registrei|registros?|refeic(?:ao|oes)|agua|exercicios?|evolucao|historico|habitos?)\b/;
...
export function resolveQuestionContextScope(question: string): QuestionContextScope {
  ...
  const needsPersonalContext = PERSONAL_CONTEXT_PATTERN.test(normalized);

...
// Used only as high-margin affirmative negative evidence after positive catalog,
// explicit semantic guards and contextual object evidence. Mid-confidence scores
// abstain: catalog absence or a fixed calibration set never decides by default.
...
const NON_FOOD_MAX_FOOD_PROBABILITY = 0.1;

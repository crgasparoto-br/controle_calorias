...
export const FOOD_CATALOG_REFERENCE: CatalogFoodReference[] = [
  ...
  {
    // Valores públicos por porção consultados em 21/09/2026; a embalagem pode
    // ser lida como "Pro Nuts" ou "Duo Nuts".
    slug: "ouro-branco-duo-nuts-lacta",
    name: "Ouro Branco Duo Nuts Lacta",
    aliases: [
      "ouro branco duo nuts",
      "ouro branco pro nuts",
      "duo nuts lacta",
      "pro nuts lacta",
      "bombom ouro branco duo nuts",
      "bombom ouro branco pro nuts",
    ],
    servingLabel: "1 unidade (22 g)",
    gramsPerServing: 22,
    calories: 114,
    protein: 1.1,
    carbs: 14.0,
    ...
    processingLevel: "ultra_processed",
    brandName: "Lacta",
    variants: ["duo nuts", "pro nuts", "nuts"],
    isUltraProcessed: true,
    isBrandedProduct: true,
  },
  {
    // Valores públicos por porção consultados em 21/09/2026.
    slug: "amandita-recheada-creme-cacau-lacta",
    name: "Amandita Recheada de Creme com Cacau Lacta",
    aliases: [
      "amandita",
      "amandita recheada",
      "amandita recheada de creme com cacau",
      "amandita creme com cacau",
      "wafer amandita lacta",
      "amandita lacta",
    ],
    servingLabel: "3 unidades (30 g)",
    gramsPerServing: 30,
    calories: 156,
    protein: 1.4,
    carbs: 20.0,
    ...
    processingLevel: "ultra_processed",
    brandName: "Lacta",
    variants: ["recheada", "creme com cacau", "creme de cacau"],
    isUltraProcessed: true,
    isBrandedProduct: true,
  },
  {

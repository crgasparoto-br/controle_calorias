  ...
  const content: AiInputContentItem[] = [
    {
      ...
      text: [
        ...
        "Em qualquer imagem com vários alimentos ou produtos, faça primeiro um inventário visual: cada produto/linha claramente distinto deve permanecer como item independente. Não deixe um produto comercial dominante apagar outras linhas ou produtos visíveis; unidades idênticas podem ser agregadas em quantity somente quando a contagem estiver clara.",
        "Conte cada unidade ou embalagem consumível claramente visível quando isso for possível e preserve a evidência/nível de confiança por item. Se apenas um item estiver ambíguo, mantenha os demais itens reconhecíveis no array items e não converta a imagem inteira em ausência de alimento.",
        ...
        "Quando usar tabela nutricional visível, o reasoning deve conter exatamente um trecho machine-readable no formato 'NUTRITION_LABEL_EVIDENCE: serving=<quantidade> <unidade>; kcal=<valor>; protein_g=<valor>; carbs_g=<valor>; fat_g=<valor>' com a porção-base e os quatro valores copiados do rótulo, usando ponto decimal. Só inclua esse marcador quando a porção-base e todos os quatro valores estiverem legíveis na imagem.",
        "Se a tabela estiver citada mas qualquer valor ou a porção-base estiver ausente, ilegível ou apenas inferida, não inclua NUTRITION_LABEL_EVIDENCE; os macros podem permanecer como estimativa revisável, mas não serão tratados como rótulo verificado.",

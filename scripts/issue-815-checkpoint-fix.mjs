...
const legacyPersist = "  const persistedAccess = await persistAccessForBothSides(access);";
...
} else if (!content.includes("const professionalMap = new Map<number, ProfessionalProfile>();")) {

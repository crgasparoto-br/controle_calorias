...
const quickReference = [
  ...
  ["Investigar possível abuso ou registrar legal hold", "Governança"],
  ["Controlar coortes, gates, pausas e rollback", "Rollout"],
];
  ...
  return (
    <section className="space-y-6" aria-labelledby="billing-manual-title">
        ...
        <CardHeader>
          <div className="flex flex-wrap items-start justify-between gap-3">
            <div className="space-y-1">
              ...
              <CardDescription>
                Consulte aqui como operar planos, acessos, catálogo, campanhas, governança e rollout.
        ...
        <CardContent className="space-y-4 text-sm leading-6">
          <div className="rounded-xl border bg-muted/20 p-4">
            ...
            <p className="mt-1 text-muted-foreground">
              Liberações administrativas, franquias temporárias e controles de rollout não criam
          ...
          <div className="grid gap-3 md:grid-cols-2 xl:grid-cols-5">
            {[
              ...
              ["Acessos", "Consultar elegibilidade e administrar exceções."],
              ["Comercial", "Gerenciar catálogo, cupons e comunicações."],
              ["Governança", "Analisar economia, uso e exceções operacionais."],
              ["Rollout", "Controlar implantação comercial progressiva."],
      ...
      <ManualSection title="1. Visão geral" summary="Indicadores de contratos, planos e receita recorrente.">
        <p>
          A aba <strong>Visão geral</strong> é consultiva. No topo da página também aparecem os KPIs de
          assinaturas ativas, inadimplentes, usuários sem origem comercial válida e liberações
          administrativas ativas.
        </p>
        <div className="space-y-2">
          <h4 className="font-medium">Distribuição por plano e ciclo</h4>
          <p className="text-muted-foreground">
            Para cada versão de plano, confira nome, versão comercial, ciclo, moeda, estado do catálogo,
            assinaturas por status, beneficiários cobertos e capacidade ocupada.
          </p>
        </div>
        <div className="space-y-2">
          ...
          <p className="text-muted-foreground">
            ...
            administrativo e não substitui a conciliação financeira.
          </p>
        </div>
      </ManualSection>

      <ManualSection title="2. Acessos" summary="Pesquisa de usuários, origem do acesso e liberações administrativas." open>
        <div className="space-y-2">
          <h4 className="font-medium">Localizar um usuário</h4>
          <ol className="list-decimal space-y-1 pl-5 text-muted-foreground">
            <li>Pesquise por nome, e-mail ou telefone.</li>
            <li>Se necessário, filtre pela origem do acesso.</li>
            <li>Selecione o usuário para consultar sua situação e o histórico de liberações.</li>
          </ol>
          <p className="text-muted-foreground">
            Origens disponíveis: {accessReasons.join(", ")}.
          </p>
        </div>
      ...
      <ManualSection title="3. Comercial" summary="Catálogo, versões, cupons, campanhas e entregas.">
        <div className="space-y-2">
        ...
        <div className="space-y-2">
          ...
          <p className="text-muted-foreground">
            ...
            marco, canal e status. Cada item mantém separadas a central interna, e-mail, WhatsApp,
            tentativas, retries e correlação com o fato original.
          </p>
          <ul className="list-disc space-y-1 pl-5 text-muted-foreground">
            <li><strong>Retry WhatsApp / Retry e-mail:</strong> exige motivo auditável.</li>
      ...
      <ManualSection title="4. Governança" summary="Economia, franquias temporárias, possível abuso e retenção.">
        <div className="space-y-2">
          ...
          <p className="text-muted-foreground">
            A visão econômica apresenta competência, receita, descontos, refunds, impostos, receita líquida,
            custo variável, índices, custo financeiro e cobertura. É uma visão gerencial e não substitui
            escrituração contábil ou conciliação financeira.
          </p>
        </div>
        ...
        <div className="space-y-2">
          <h4 className="font-medium">Retenção e legal hold</h4>
          <p className="text-muted-foreground">
            Legal hold impede a eliminação somente do escopo documentado. A administração pode registrar,
            consultar e revogar holds, além de reprocessar retenção quando necessário. A revogação preserva
            o histórico.
          </p>
        </div>
      </ManualSection>

      <ManualSection title="5. Rollout" summary="Coortes, pausa, retomada, rollback, gates e incidentes.">
        <p className="text-muted-foreground">
          O rollout é uma área operacional sensível e sua progressão é sempre manual. Nenhuma ação desta
          aba cria cobrança ou assinatura.
        </p>

        <div className="space-y-2">
          <h4 className="font-medium">Congelar coorte</h4>
          <ol className="list-decimal space-y-1 pl-5 text-muted-foreground">
            <li>Selecione a fase e o percentual.</li>
            <li>Informe chave do snapshot, versão da regra e critério determinístico.</li>
            <li>Informe os IDs candidatos e o motivo.</li>
            <li>Clique em <strong>Congelar snapshot</strong>.</li>
          </ol>
        </div>

        <div className="space-y-2">
          <h4 className="font-medium">Pausar, retomar e registrar rollback</h4>
          <p className="text-muted-foreground">
            Pausa exige justificativa. Retomada e rollback exigem confirmação reforçada do administrador.
            Essas ações preservam cobranças, assinaturas, estornos, cancelamentos, capacidade e demais fatos
            legítimos já registrados.
          </p>
        </div>

        <div className="space-y-2">
          <h4 className="font-medium">Gate manual da etapa</h4>
          <p className="text-muted-foreground">
            Registre a decisão de manter, avançar ou reprovar a etapa, identificando responsáveis de Produto,
            Técnico, Billing, Suporte e administrador autorizador, além das métricas, evidências e motivo da
            decisão.
          </p>
        </div>
        ...
        <div className="space-y-2">
          ...
          <p className="text-muted-foreground">
            Registre tipo, severidade, causa e impacto. Incidentes relevantes podem impedir o avanço da fase
      ...
      <div className="rounded-xl border border-dashed p-4 text-sm leading-6 text-muted-foreground">
        ...
        de rollout para simular pagamento, assinatura, cancelamento ou conciliação financeira.
      </div>
    </section>
  );
}

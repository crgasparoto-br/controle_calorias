...
const METADATA_LABELS: Record<string, string> = {
  ...
  caloriesOrigin: "Origem das calorias",
  commute: "Deslocamento",
...
const METADATA_VALUE_LABELS: Record<string, string> = {
  ...
  commute: "Deslocamento",
  easy: "Leve",
  estimated_activity: "Estimativa local de atividade",
  estimated_strength: "Estimativa local de musculação",
  everyone: "Público",
  false: "Não",
  ...
  private: "Privado",
  public: "Público",
  strava_detail: "Strava (dados do dispositivo)",
  strava_summary: "Strava (estimativa do perfil)",
  synced: "Sincronizado",
  true: "Sim",
};

      ...
      <div className="mx-auto flex max-w-7xl flex-col gap-6">
        ...
        <section className="grid gap-4 xl:grid-cols-[1.05fr,0.95fr]">
          <div className="space-y-4">
            ...
            <MealsOfDayCard groupedMeals={groupedSelectedDayMeals} consumedCalories={consumedCalories} consumedProtein={consumedProtein} consumedCarbs={consumedCarbs} consumedFat={consumedFat} />
          </div>

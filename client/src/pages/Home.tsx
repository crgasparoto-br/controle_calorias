      ...
      <div className="space-y-8">
        ...
        <section className="space-y-4">
          <SectionHeading
            ...
            description="Indicadores de qualidade alimentar e motivação semanal agora ficam lado a lado para reduzir a quebra de contexto."
          />
        ...
        <section className="space-y-4">
          <SectionHeading
            ...
            description="Esses cartões concentram os quatro totais mais consultados sem duplicar explicações longas."
          />
          <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
        ...
        <section className="space-y-4">
          <SectionHeading
            title="Energia e semana"
            description="A parte semanal foi agrupada para mostrar saldo, tendência e leitura de adesão sem espalhar a análise em blocos distantes."
          />
        ...
        <section className="space-y-4">
          <SectionHeading
            ...
            description="Exercícios e água ficam juntos porque costumam ser atualizados em sequência durante o dia."
          />
        ...
        <section className="space-y-4">
          <SectionHeading
            ...
            description="As últimas confirmações seguem disponíveis no Dashboard, mas agora em um encerramento mais limpo da página."
          />

...
function ReportsSupportFallback() {
  return (
    <span className="sr-only">
      Peso como apoio à leitura. Inicial. Atual. Variação. Aderência calórica. Ainda não há registros de peso no período selecionado. Resumo de aderência à meta ajustada. Resumo de peso como apoio à leitura. Aderência ajustada. Meta ajustada total. Registrar refeição.
    </span>
  );
}

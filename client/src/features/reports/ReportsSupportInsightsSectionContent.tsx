...
const ReportsWeightTrendChart = lazy(() => import("@/features/reports/ReportsWeightTrendChart"));
...
export default function ReportsSupportInsightsSectionContent({ scopeLabel, trendData, dayCount, weight }: ReportsSupportInsightsSectionProps) {

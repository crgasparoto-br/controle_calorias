...
- Quando não houver referência interna exata para um produto com marca reconhecida, o fluxo usa a capacidade canônica `NUTRITION_SEARCH` para buscar fonte rastreável. Produto, marca, variante e porção precisam ser compatíveis. Se a visão sustentar, com confiança suficiente, uma identidade de produto específica e a busca não encontrar uma fonte compatível, o sistema pode preservar a identidade e a estimativa da própria visão como `provisional_estimate`, sempre marcada como não verificada e sujeita à revisão. Identidade genérica, baixa confiança, marca sem produto específico ou múltiplas alternativas continuam preservando a identidade, zerando a composição não comprovada e solicitando clarificação; não é permitido reutilizar macros genéricos como se fossem do produto de marca.
...
- Em uma imagem com vários alimentos ou produtos, cada linha/produto visualmente distinto permanece como item independente. Unidades idênticas podem ser agregadas somente quando a contagem estiver clara; a incerteza de um item não apaga os demais nem transforma o conjunto em ausência global de alimento.

...
- percentual de calorias não classificadas para deixar clara a limitação dos dados, sem listar os alimentos individuais não classificados (o detalhamento item a item fica fora de Relatórios; ver pipeline de classificação automática em `docs/product-specs/meal-registration.md`);

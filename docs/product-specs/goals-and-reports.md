...
## Coerência temporal entre telas

Hoje, Registros, Metas e Relatórios usam o timezone efetivo do dono dos dados para selecionar o dia, semana, mês e período. Alterar o timezone invalida os caches temporais e refaz as consultas sem novo login. Horários civis inexistentes por DST são rejeitados; horários ambíguos seguem a primeira ocorrência definida pelo contrato central.

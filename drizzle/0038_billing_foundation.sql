...
ALTER TABLE `billingCapacityAllocations` ADD CONSTRAINT `billingCapacityAllocations_subscriptionId_fk` FOREIGN KEY (`subscriptionId`) REFERENCES `billingSubscriptions`(`id`) ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE `billingCapacityAllocations` ADD CONSTRAINT `billingCapacityAllocations_authorizationId_fk` FOREIGN KEY (`authorizationId`) REFERENCES `professionalPatientAuthorizations`(`id`) ON DELETE set null ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE `billingEntitlements` ADD CONSTRAINT `billingEntitlements_professionalAuthorizationId_fk` FOREIGN KEY (`professionalAuthorizationId`) REFERENCES `professionalPatientAuthorizations`(`id`) ON DELETE set null ON UPDATE no action;--> statement-breakpoint

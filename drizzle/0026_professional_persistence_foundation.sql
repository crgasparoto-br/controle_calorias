...
ALTER TABLE `professionalPatientTrackingEvents` ADD CONSTRAINT `professionalPatientTrackingEvents_tracking_fk` FOREIGN KEY (`trackingId`) REFERENCES `professionalPatientTrackings`(`id`) ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE `professionalPatientTrackingEvents` ADD CONSTRAINT `professionalPatientTrackingEvents_authorization_fk` FOREIGN KEY (`authorizationId`) REFERENCES `professionalPatientAuthorizations`(`id`) ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE `professionalPatientTrackings` ADD CONSTRAINT `professionalPatientTrackings_authorization_fk` FOREIGN KEY (`authorizationId`) REFERENCES `professionalPatientAuthorizations`(`id`) ON DELETE cascade ON UPDATE no action;--> statement-breakpoint

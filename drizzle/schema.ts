...
export const userProfiles = mysqlTable(
  "userProfiles",
  {
    ...
    sex: mysqlEnum("sex", ["female", "male", "non_binary", "prefer_not_to_say"])
      .default("prefer_not_to_say")
      .notNull(),
    heightCm: double("heightCm"),
    currentWeightKg: double("currentWeightKg"),
    nutritionObjective: mysqlEnum("nutritionObjective", [
      "emagrecer",
      "manter_peso",
      "ganhar_massa",
      "melhorar_habitos",
    ...
    trackingExperience: mysqlEnum("trackingExperience", [
      "beginner",
      "intermediate",
      "advanced",
    ]),
    eatingRoutine: mysqlEnum("eatingRoutine", [
      "cozinha_em_casa",
      "come_fora",
      "delivery",
      "marmita",
    ...
    mainDifficulty: mysqlEnum("mainDifficulty", [
      "fome",
      "ansiedade",
      "falta_de_tempo",
      "beliscos",
...
export const nutritionGoals = mysqlTable(
  "nutritionGoals",
  {
    ...
    userId: int("userId")
      .notNull()
      .references(() => users.id, { onDelete: "cascade" }),
    ruleType: mysqlEnum("ruleType", ["default", "exception"])
      .default("default")
      .notNull(),
    weekday: int("weekday").default(-1).notNull(),
    durationType: mysqlEnum("durationType", [
      "1_week",
      "2_weeks",
      "3_weeks",
      "always",
  ...
  table => ({
    ...
    userRuleWindowUnique: uniqueIndex("nutritionGoals_user_rule_window_idx").on(
      table.userId,
      table.ruleType,
      table.weekday,
      table.effectiveFrom
...
export const foodBrands = mysqlTable(
  "foodBrands",
  {
    id: int("id").autoincrement().primaryKey(),
  ...
  table => ({
    normalizedNameIdx: index("foodBrands_normalizedName_idx").on(
      table.normalizedName
    ),
  })
);

export const foodSources = mysqlTable(
  "food_sources",
  {
    id: int("id").autoincrement().primaryKey(),
  ...
  table => ({
    ...
    slugVersionUnique: uniqueIndex("food_sources_slug_version_unique").on(
      table.slug,
      table.version
    ),
  })
...
export const foods = mysqlTable(
  "foods",
  {
    ...
    sourceId: int("source_id").references(() => foodSources.id, {
      onDelete: "set null",
    }),
    ...
    status: mysqlEnum("status", ["active", "deprecated", "merged"])
      .default("active")
      .notNull(),
    mergedIntoFoodId: int("merged_into_food_id").references(
      (): AnyMySqlColumn => foods.id,
      { onDelete: "set null" }
    ),
  ...
  table => ({
    ...
    normalizedNameIdx: index("foods_normalized_name_idx").on(
      table.normalizedName
    ),
    scopeSearchIdx: index("foods_scope_search_idx").on(
      table.ownerUserId,
      table.normalizedName
    ),
    statusIdx: index("foods_status_idx").on(table.status),
    mergedIntoFoodIdIdx: index("foods_merged_into_food_id_idx").on(
      table.mergedIntoFoodId
    ),
    sourceCodeUnique: uniqueIndex("foods_source_code_unique").on(
      table.sourceId,
      table.sourceFoodCode
    ),
  })
);

export const foodAliases = mysqlTable(
  "food_aliases",
  {
    id: int("id").autoincrement().primaryKey(),
    foodId: int("food_id")
  ...
  table => ({
    normalizedAliasIdx: index("food_aliases_normalized_alias_idx").on(
      table.normalizedAlias
    ),
    sourceIdIdx: index("food_aliases_source_id_idx").on(table.sourceId),
    foodAliasUnique: uniqueIndex("food_aliases_food_alias_unique").on(
      table.foodId,
      table.normalizedAlias
    ),
  })
...
export const foodPortions = mysqlTable(
  "food_portions",
  {
    id: int("id").autoincrement().primaryKey(),
    foodId: int("food_id")
  ...
  table => ({
    ...
    foodLabelUnitUnique: uniqueIndex("food_portions_food_label_unit_unique").on(
      table.foodId,
...
export const foodCatalog = mysqlTable(
  "foodCatalog",
  {
    id: int("id").autoincrement().primaryKey(),
    ...
    brandId: int("brandId").references(() => foodBrands.id, {
      onDelete: "set null",
    }),
    brandName: varchar("brandName", { length: 255 }),
    foodType: mysqlEnum("foodType", ["generic", "branded"])
      .default("generic")
      .notNull(),
    ...
    status: mysqlEnum("status", ["active", "deprecated"])
      .default("active")
      .notNull(),
    createdAt: timestamp("createdAt").defaultNow().notNull(),
    updatedAt: timestamp("updatedAt").defaultNow().onUpdateNow().notNull(),
  ...
  table => ({
    ...
    createdByUserIdx: index("foodCatalog_createdByUserId_idx").on(
...
export const foodFavorites = mysqlTable(
  "foodFavorites",
  {
    ...
    foodCatalogId: int("foodCatalogId")
      .notNull()
      .references(() => foodCatalog.id, { onDelete: "cascade" }),
    createdAt: timestamp("createdAt").defaultNow().notNull(),
  },
  table => ({
    userFoodUnique: uniqueIndex("foodFavorites_user_food_idx").on(
      table.userId,
      table.foodCatalogId
    ),
...
export const userGamificationSettings = mysqlTable(
...
export const userBadges = mysqlTable(
  ...
  table => ({
    userBadgeUnique: uniqueIndex("userBadges_user_badge_week_idx").on(
      table.userId,
      table.badgeCode,
      table.weekStart
    ),
...
export const portions = mysqlTable(
  "portions",
  {
    id: int("id").autoincrement().primaryKey(),
    foodCatalogId: int("foodCatalogId")
  ...
  table => ({
    foodCatalogIdIdx: index("portions_foodCatalogId_idx").on(
      table.foodCatalogId
    ),
    foodUnitIdx: index("portions_food_unit_idx").on(
      table.foodCatalogId,
      table.unit
    ),
  })
...
export const recipeItems = mysqlTable(
  "recipeItems",
  {
    id: int("id").autoincrement().primaryKey(),
    ...
    foodCatalogId: int("foodCatalogId").references(() => foodCatalog.id, {
      onDelete: "set null",
    }),
    portionId: int("portionId").references(() => portions.id, {
      onDelete: "set null",
    }),
    quantity: double("quantity").default(1).notNull(),
  ...
  table => ({
    ...
    foodCatalogIdIdx: index("recipeItems_foodCatalogId_idx").on(
      table.foodCatalogId
    ),
...
export const meals = mysqlTable(
  ...
  table => ({
    userOccurredAtIdx: index("meals_user_occurredAt_idx").on(
      table.userId,
      table.occurredAt
    ),
    userStatusOccurredAtIdx: index("meals_user_status_occurredAt_idx").on(
      table.userId,
      table.status,
      table.occurredAt
    ),
...
export const mealItems = mysqlTable(
  "mealItems",
  {
    ...
    itemType: mysqlEnum("itemType", ["food", "recipe", "free_text"])
      .default("food")
      .notNull(),
    ...
    carbs: double("carbs").notNull(),
    fat: double("fat").notNull(),
    source: mysqlEnum("source", ["catalog", "hybrid", "heuristic"])
      .default("catalog")
      .notNull(),
    createdAt: timestamp("createdAt").defaultNow().notNull(),
  },
  table => ({
    ...
    foodCatalogIdIdx: index("mealItems_foodCatalogId_idx").on(
      table.foodCatalogId
    ),
...
export const mealMedia = mysqlTable(
  "mealMedia",
  {
    id: int("id").autoincrement().primaryKey(),
    mealId: int("mealId")
...
export const mealFavorites = mysqlTable(
  "mealFavorites",
  {
    id: int("id").autoincrement().primaryKey(),
    userId: int("userId")
  ...
  table => ({
    ...
    userNameUnique: uniqueIndex("mealFavorites_user_name_idx").on(
      table.userId,
      table.name
    ),
  })
...
export const mealInferences = mysqlTable(
  "mealInferences",
  {
    id: int("id").autoincrement().primaryKey(),
...
export const habitMemories = mysqlTable(
  "habitMemories",
  {
    id: int("id").autoincrement().primaryKey(),
    userId: int("userId")
  ...
  table => ({
    userFoodIdx: index("habitMemories_user_food_idx").on(
      table.userId,
      table.foodName
    ),
    userLastSeenIdx: index("habitMemories_user_lastSeen_idx").on(
      table.userId,
      table.lastSeenAt
    ),
  })
...
export const dailySummaries = mysqlTable(
  ...
  table => ({
    userSummaryDateIdx: index("dailySummaries_user_summaryDate_idx").on(
      table.userId,
      table.summaryDate
    ),
  })
...
export const exercises = mysqlTable(
  ...
  table => ({
    userOccurredAtIdx: index("exercises_user_occurredAt_idx").on(
      table.userId,
      table.occurredAt
    ),
    externalReferenceIdx: index("exercises_external_reference_idx").on(
      table.externalProvider,
      table.externalId
    ),
    userExternalReferenceUnique: uniqueIndex(
      "exercises_user_external_reference_unique"
    ).on(table.userId, table.externalProvider, table.externalId),
  })
);

export const healthSyncedRecords = mysqlTable(
  "healthSyncedRecords",
  {
    id: int("id").autoincrement().primaryKey(),
    userId: int("userId")
  ...
  table => ({
    userMeasuredAtIdx: index("healthSyncedRecords_user_measuredAt_idx").on(
      table.userId,
      table.measuredAt
    ),
    userProviderIdx: index("healthSyncedRecords_user_provider_idx").on(
      table.userId,
      table.provider
    ),
    userDataTypeIdx: index("healthSyncedRecords_user_dataType_idx").on(
      table.userId,
      table.dataType
    ),
    userProviderRecordUnique: uniqueIndex(
      "healthSyncedRecords_user_provider_record_idx"
    ).on(table.userId, table.provider, table.externalRecordId, table.dataType),
  })
);
...
export const weightEntries = mysqlTable(
  ...
  table => ({
    userMeasuredAtIdx: index("weightEntries_user_measuredAt_idx").on(
      table.userId,
      table.measuredAt
    ),
  })
...
export const waterLogs = mysqlTable(
  ...
  table => ({
    userOccurredAtIdx: index("waterLogs_user_occurredAt_idx").on(
      table.userId,
      table.occurredAt
    ),
  })
...
export const userPreferences = mysqlTable(
  ...
  table => ({
    userKeyUnique: uniqueIndex("userPreferences_user_key_idx").on(
      table.userId,
      table.preferenceKey
    ),
  })
...
export const userRestrictions = mysqlTable(
  "userRestrictions",
  {
    ...
    severity: mysqlEnum("severity", ["info", "avoid", "strict"])
      .default("info")
      .notNull(),
    notes: text("notes"),
    createdAt: timestamp("createdAt").defaultNow().notNull(),
  ...
  table => ({
    userTypeIdx: index("userRestrictions_user_type_idx").on(
      table.userId,
      table.restrictionType
    ),
    userLabelIdx: index("userRestrictions_user_label_idx").on(
      table.userId,
      table.label
    ),
  })
...
export const whatsappConnections = mysqlTable(
  ...
  table => ({
    ...
    phoneNumberIdx: index("whatsappConnections_phoneNumber_idx").on(
      table.phoneNumber
    ),
  })
);
...
export const whatsappConversations = mysqlTable(
  ...
  table => ({
    userStatusIdx: index("whatsappConversations_user_status_idx").on(
      table.userId,
      table.status
    ),
    userLastActivityIdx: index(
      "whatsappConversations_user_lastActivityAt_idx"
...
export const whatsappConversationMessages = mysqlTable(
  ...
  table => ({
    conversationOccurredIdx: index(
      "whatsappConversationMessages_conversation_occurredAt_idx"
    ).on(table.conversationId, table.occurredAt, table.id),
    userOccurredIdx: index(
      "whatsappConversationMessages_user_occurredAt_idx"
    ).on(table.userId, table.occurredAt, table.id),
    idempotencyKeyUniqueIdx: uniqueIndex(
      "whatsappConversationMessages_idempotencyKey_unique_idx"
    ).on(table.idempotencyKey),
    respondsToIdx: index("whatsappConversationMessages_respondsTo_idx").on(
      table.respondsToMessageId
    ),
...
export type WhatsAppConversationMessage =
  typeof whatsappConversationMessages.$inferSelect;
export type InsertWhatsAppConversationMessage =
  typeof whatsappConversationMessages.$inferInsert;

export const whatsappMessageDomainLinks = mysqlTable(
  "whatsappMessageDomainLinks",
  {
    id: int("id").autoincrement().primaryKey(),
    messageId: int("messageId").notNull(),
    mealId: int("mealId").references(() => meals.id, { onDelete: "set null" }),
    mealItemId: int("mealItemId").references(() => mealItems.id, {
      onDelete: "set null",
    }),
    waterLogId: int("waterLogId").references(() => waterLogs.id, {
      onDelete: "set null",
    }),
    weightEntryId: int("weightEntryId").references(() => weightEntries.id, {
      onDelete: "set null",
    }),
  ...
  table => ({
    messageIdIdx: index("whatsappMessageDomainLinks_messageId_idx").on(
      table.messageId
    ),
    mealIdIdx: index("whatsappMessageDomainLinks_mealId_idx").on(table.mealId),
    waterLogIdIdx: index("whatsappMessageDomainLinks_waterLogId_idx").on(
      table.waterLogId
    ),
    weightEntryIdIdx: index("whatsappMessageDomainLinks_weightEntryId_idx").on(
      table.weightEntryId
    ),
    exerciseIdIdx: index("whatsappMessageDomainLinks_exerciseId_idx").on(
      table.exerciseId
    ),
...
export type WhatsAppMessageDomainLink =
  typeof whatsappMessageDomainLinks.$inferSelect;
export type InsertWhatsAppMessageDomainLink =
  typeof whatsappMessageDomainLinks.$inferInsert;

export const whatsappConversationSummaries = mysqlTable(
  ...
  table => ({
    conversationIdx: index(
      "whatsappConversationSummaries_conversation_createdAt_idx"
    ...
    conversationToMessageUniqueIdx: uniqueIndex(
      "wa_conv_summary_conv_to_msg_unique_idx"
    ).on(table.conversationId, table.toMessageId),
    conversationFk: foreignKey({
...
export type WhatsAppConversationSummary =
  typeof whatsappConversationSummaries.$inferSelect;
export type InsertWhatsAppConversationSummary =
  typeof whatsappConversationSummaries.$inferInsert;

export const whatsappPendingOperations = mysqlTable(
  ...
  table => ({
    userStateIdx: index("wa_pending_op_user_state_idx").on(
      table.userId,
      table.state
    ),
    userFk: foreignKey({
...
export type WhatsAppPendingOperation =
  typeof whatsappPendingOperations.$inferSelect;
export type InsertWhatsAppPendingOperation =
  typeof whatsappPendingOperations.$inferInsert;
...
export const appSecrets = mysqlTable(
  ...
  table => ({
    updatedByUserIdIdx: index("appSecrets_updatedByUserId_idx").on(
      table.updatedByUserId
    ),
  })
);

export const inferenceLogs = mysqlTable(
  "inferenceLogs",
  {
    id: int("id").autoincrement().primaryKey(),
    userId: int("userId").references(() => users.id, { onDelete: "set null" }),
    origin: mysqlEnum("origin", ["web", "whatsapp", "admin"])
      .default("web")
      .notNull(),
    status: mysqlEnum("status", ["success", "warning", "error"])
      .default("success")
      .notNull(),
  ...
  table => ({
    userCreatedAtIdx: index("inferenceLogs_user_createdAt_idx").on(
      table.userId,
      table.createdAt
    ),
...
export const quickEditTokens = mysqlTable(
  "quickEditTokens",
  {
    id: int("id").autoincrement().primaryKey(),
    userId: int("userId")
  ...
  table => ({
    userMealIdx: index("quickEditTokens_user_meal_idx").on(
      table.userId,
      table.mealId
    ),
...
export type UserGamificationSetting =
  typeof userGamificationSettings.$inferSelect;
export type InsertUserGamificationSetting =
  typeof userGamificationSettings.$inferInsert;
